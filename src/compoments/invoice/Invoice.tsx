...
const Invoice = React.forwardRef<HTMLDivElement, InvoiceProps>(({ date = new Date(), numerazione, operazione, nominativo, entrata, codice_fiscale }, ref) => {
